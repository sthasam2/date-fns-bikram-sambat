...
describe("set", () => {
	...
	it("sets year", () => {
		...
		expect(result).toEqual(/* 2071/04/16 */ new Date(2014, 8 /* Sep */));
	});
	...
	it("sets hours", () => {
		const result = set(/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1), {
			hours: 12,
		});
		expect(result).toEqual(/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 12));
	});

	it("sets minutes", () => {
		const result = set(/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 1), {
			minutes: 12,
		});
		expect(result).toEqual(
			/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 1, 12),
		);
	});

	it("sets seconds", () => {
		const result = set(/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 1, 1), {
			seconds: 12,
		});
		expect(result).toEqual(
			/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 1, 1, 12),
		);
	});

	it("sets milliseconds", () => {
		const result = set(
			/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 1, 1, 1),
			{
				milliseconds: 500,
			},
		);
		expect(result).toEqual(
			/* 2071/04/16 */ new Date(2014, 8 /* Sep */, 1, 1, 1, 1, 500),
		);
	});
	...
	describe("context", () => {
		...
		it("resolves the context date type", () => {
			const date = new Date(/* 2071/04/16 */ "2014-09-01T00:00:00Z");
