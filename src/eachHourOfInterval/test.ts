...
describe("eachHourOfInterval", () => {
	...
	it("returns reversed array if the start date is after the end date", () => {
		const result = eachHourOfInterval({
			start: /* 1393/7/14 */ new Date(2014, 9 /* Oct */, 6, 15),
	...
	it("normalizes the dates", () => {
		...
		expect(
			...
			/* 1403/6/19 */ "2024-09-09T07:00:00.000-04:00",
			/* 1403/6/19 */ "2024-09-09T06:00:00.000-04:00",
		]);
		expect(
			eachHourOfInterval({ start: dateRight, end: dateLeft }).map((d) =>
				d.toISOString(),
			),
		).toEqual([/* 1403/6/19 */ "2024-09-09T16:00:00.000+05:30"]);
	});
	...
	describe("context", () => {
		it("allows to specify the context", () => {
			...
			expect(
				...
				/* 1403/1/22 */ "2024-04-10T01:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T02:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T03:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T04:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T05:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T06:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T07:00:00.000-07:00",
				/* 1403/1/22 */ "2024-04-10T08:00:00.000-07:00",
			]);
			expect(
				eachHourOfInterval(interval, {
				...
				/* 1403/1/22 */ "2024-04-10T16:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T17:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T18:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T19:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T20:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T21:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T22:00:00.000+08:00",
				/* 1403/1/22 */ "2024-04-10T23:00:00.000+08:00",
			]);
		});

		it("resolves the context date type", () => {
			const interval = {
				start: new Date(/* 2071/04/16 */ "2014-09-01T00:00:00Z"),
				end: new Date(/* 2071/04/16 */ "2014-09-01T03:00:00Z"),
			};
