...
testScript(["cdn.min.js", "locale/cdn.min.js"], (dom) => {
  ...
  const faResult = dom.window.eval(
    `window.dateFnsBikramSambat.formatRelative(window.dateFnsBikramSambat.subDays(new Date(1987, 1, 11), 3), new Date(1987, 1, 11), { locale: window.dateFnsBikramSambat.locale.faIR })`,
  );
  console.log(
